...
def main():
    ...
    #confusion_matrix=[[430,  64,  47,  39,  48,   5,  33,  17, 271,  46],[14, 750,   2,  26,  17,   4,  58,  12,  56,  61],[ 72,  11, 185, 182, 269,  18, 158,  62,  33,  10],[ 13,  19,  42, 481, 126,  46, 164,  74,  16,  19],[ 23,  19,  49,  82, 544,   3, 181,  81,  15,   3],[  2,   7,  47, 403, 166, 154, 112,  87,  12,  10],[  1,  10,  16, 113, 128,   1, 700,  21,   4,   6],[ 13,  10,  14, 141, 183,  31,  65, 518,   7,  18],[ 81, 140,  11,  34,  12,   6,  21,   9, 623,  63],[ 21, 352,   3,  37,  21,  13,  75,  46,  72, 360]]
    print("\t%5s %5s %5s %5s %5s %5s %5s %5s %5s %5s" % (classes[:]))
    for i in range(10):
        if(i==0):
            print("%5s [%5d %5d %5d %5d %5d %5d %5d %5d %5d %5d" % (classes[i],confusion_matrix[i][0],confusion_matrix[i][1],confusion_matrix[i][2],confusion_matrix[i][3],confusion_matrix[i][4],confusion_matrix[i][5],confusion_matrix[i][6],confusion_matrix[i][7],confusion_matrix[i][8],confusion_matrix[i][9]))
        elif(i!=9):
            print("%5s  %5d %5d %5d %5d %5d %5d %5d %5d %5d %5d" % (classes[i],confusion_matrix[i][0],confusion_matrix[i][1],confusion_matrix[i][2],confusion_matrix[i][3],confusion_matrix[i][4],confusion_matrix[i][5],confusion_matrix[i][6],confusion_matrix[i][7],confusion_matrix[i][8],confusion_matrix[i][9]))
        else:
            print("%5s  %5d %5d %5d %5d %5d %5d %5d %5d %5d %5d ]" % (classes[i],confusion_matrix[i][0],confusion_matrix[i][1],confusion_matrix[i][2],confusion_matrix[i][3],confusion_matrix[i][4],confusion_matrix[i][5],confusion_matrix[i][6],confusion_matrix[i][7],confusion_matrix[i][8],confusion_matrix[i][9]))
